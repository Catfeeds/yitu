...
<body>
	...
	<div class="cf">
		...
		<div class="search-form fr cf">
			<div class="sleft">
				<input type="text" name="nickname" class="search-input" value="<?php echo I('car_title');?>" placeholder="请输入车名/车牌">
    ...
    <tbody>
		<?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td>
				<?php if(($vo["car_ownership"]) != "1"): ?>外调
				<?php else: ?>
					公司<?php endif; ?>
				<!--<?php echo ($vo["car_ownership"]); ?>-->
			</td>
			<td><?php echo ($vo["car_status"]); ?></td>
			<td>
				<a href="<?php echo U('Car/edit?id='.$vo['id']);?>">编辑</a>
				<a href="<?php echo U('Cost/edit?id='.$vo['id']);?>">统计</a>
				<a href="<?php echo U('Car/remove?id='.$vo['id']);?>" class="confirm ajax-get">删除</a>
